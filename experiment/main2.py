...
class Experiment:
    ...
    def train_predict(self, ):
        ...
        if split_method == 'cvgroup':
            ...
            self.venn4feature(metrics_learned, metrics_engineered, metrics_y_true, pd, t=0.64)
            ...
            pd.evaluation_metrics(y_true=metrics_y_true, y_pred_prob=metrics_learned, t=0.02) # for xgb
            ...
            self.venn4feature(metrics_learned, metrics_patchsim, metrics_y_true, pd, t=0.02)
